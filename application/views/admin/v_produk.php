        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header">
              <div class="row">
                <div class="col-3">
                  <button data-toggle="modal" data-target="#modal_add" class="btn btn-block">Tambah Produk</button>
                </div>
                <div class="col-3">
                  <button data-toggle="modal" data-target="#modal_view_kategori" class="btn btn-block">Tambah Kategori</button>
                </div>
                <div class="col-3">
                  <button  data-toggle="modal" data-target="#modal_add_diskon" class="btn btn-block">Beri Diskon</button>
                </div>
                <div class="col-3">
                  <button data-toggle="modal" data-target="#modal_add_qty" class="btn btn-block">Tambah Quantity</button>
                </div>
              </div>
            </div>
