  <div class="main-content" id="panel">
    <!-- Header -->
    <div class="header pb-6"style="position:static!important;">
              ...
              <div class="row align-items-center">
                ...
                <div class="col">
                  <ul class="nav nav-pills justify-content-end">
                    <li class="nav-item mr-2 mr-md-0" data-toggle="chart" data-target="#chart-sales-danger" data-update='{"myLine":{"datasets":[{"myLine":[0, 20, 10, 30, 15, 40, 20, 60, 60]}]}}' data-prefix="$" data-suffix="k">
